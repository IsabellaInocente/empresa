...
public class ProdutoController {
	...
	public ResponseEntity<List<Produto>> buscaTodosProdutosControl(){
		List<Produto> Pedidos = produtoService.buscaTodosProduto();
		return ResponseEntity.ok(Pedidos);
	}
	@PostMapping("/")
	@Operation(summary = "Apresenta todos os Produto")
	public ResponseEntity<Produto> salvaPedidoControl(@RequestBody @Valid Produto produto){
		Produto salvaPedido = produtoService.salvaProduto(produto);
